...
import com.spencer.client.RpcClientHandler;
import com.spencer.client.RpcClientInitializer;
...
public class ConnectManage {
    ...
    private CopyOnWriteArrayList<RpcClientHandler> connectedHandlers = new CopyOnWriteArrayList<>(); //维护已经连接的handler
    private Map<InetSocketAddress, RpcClientHandler> connectedServerNodes = new ConcurrentHashMap<>(); //连接跟ip映射关系
    ...
    public RpcClientHandler chooseHandler() {
        ...
        int index = (roundRobin.getAndAdd(1) + size) % size; //简单的负载均衡
